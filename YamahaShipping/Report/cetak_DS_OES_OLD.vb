...
Public Class cetak_DS_OES_OLD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PackingYamaha.cetak_DS_OES_OLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetak_DS_OES_OLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetak_DS_OES_OLD = New cetak_DS_OES_OLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
