...
Public Class cetak_Summary_Manual
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cetak_Summary_Manual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PackingYamaha.cetak_Summary_Manual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cycle() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcetak_Summary_Manual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetak_Summary_Manual = New cetak_Summary_Manual()
        rpt.Site = Me.Site
        Return rpt
    End Function
