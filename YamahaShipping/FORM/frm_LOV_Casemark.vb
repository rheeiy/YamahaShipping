Public Class frm_LOV_Casemark
    ...
    Private Sub loadListDS()
        ...
        If myDT IsNot Nothing And myDT.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To myDT.Rows.Count - 1
                ...
                dgLOV.Item(1, i).Value = myDT.Rows(i).Item("palet_code").ToString
    ...
    Private Sub txtOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtOK.Click
        frm_cetakCasemark.txtLabel.Text = dgLOV.Item(1, dgLOV.CurrentRow.Index).Value
        frm_cetakCasemark.absId = dgLOV.Item(1, dgLOV.CurrentRow.Index).Value
