...
Public Class frm_cetakCasemark
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        If txtLabel.Text = "" Then
            MessageBox.Show("Pilih Casemark terlebih dahulu !!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
